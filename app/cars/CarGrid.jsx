  ...
  return (
    <TableHead>
      <TableRow>
        ...
        <TableCell padding="checkbox" align='center'>Editar</TableCell>
        <TableCell padding="checkbox" align='center'>Ver</TableCell>
...
export default function CarGrid(props) {
  ...
  const editarDatos = (e, car) => {
    ...
    // return alert(car);
    router.push('/cars/edit/' + '?' + createQueryString('id', `${car}`))
  };
  const verDatos = (e, car) => {

      e.stopPropagation(); // don't select this row after clicking

      router.push('/cars/look/' + '?' + createQueryString('id', `${car}`))
    };
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                      <IconButton size='small' onClick={(e) => editarDatos(e, row?.id)}>
                        <Edit fontSize='small' color='error'/>
                      </IconButton>
                    </TableCell>
                    <TableCell>
                      <IconButton size='small' onClick={(e) => verDatos(e, row?.id)}>
